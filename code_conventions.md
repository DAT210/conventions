...
- Protect your `develop` and `master` branch.
  ...
  > It protects your production-ready branches from receiving unexpected and irreversible changes. read more... [Github](https://help.github.com/articles/about-protected-branches/)
...
- Make sure your team members get the exact same dependencies as you.
  ...
  > Because you want the code to behave as expected and identical in any development machine
...
- Check to see if the package has known security vulnerabilities.
...
- Place your test files next to the tested modules using `*.test.*` or `*.spec.*` naming convention, like `moduleName.spec.js`.
...
* Put your additional test files into a separate test folder to avoid confusion.
  ...
  > Some test files don't particularly relate to any specific implementation file. You have to put it in a folder that is most likely to be found by other developers, for instance `/test`
...
* Use a static type checker, if applicable.

  _Why:_

  > Sometimes you may need a Static type checker. It brings a certain level of reliability to your code.
...
- Use automatic linters if you can to enforce code style.

- Comment as applicable and keep them relevant as code changes. Remove commented blocks of code. Explain _why_, not _how_.
...
- Use verbs for non-resources. In this case, your API doesn't return any resources. Instead, you execute an operation and return the result. These **are not** CRUD (create, retrieve, update, and delete) operations:
  ...
  > Because for CRUD we use HTTP methods on `resource` or `collection` URLs. The verbs we were talking about are actually `Controllers`.
...
Adapted from: [Elsewhen](https://github.com/elsewhencode/project-guidelines/blob/master/README.md)
