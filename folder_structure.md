...
Unit tests may be placed closer to the feature they test, depending on the size of the project. This lessens the need to go back and forth while working in the project.
...
If you have more than a simple `build.sh` script or similar, create a `/scripts` folder to organized your script files for buidling, deploying or other tasks.

### Tools and utilities

Any downloaded tools you need to perform development tasks. They should be checked in to source control to enable everyone to pull the sources and start working. Use the folder `/tools`
...
External libraries should be placed in a seperate folder, for instance `/vendor`. This keeps them seperate from the work we're doing and makes changes more explicit.
